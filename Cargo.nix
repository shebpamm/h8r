...
let
  nixifiedLockHash = "aa1c28c6d76fd84364984f0f80e1ce73122d36ef6c8bd600e1eb0658dad693a8";
...
in
{
  ...
  workspace = {
    h8r = rustPackages.unknown.h8r."2.2.0";
  };
  ...
  "unknown".h8r."2.2.0" = overridableMkRustCrate (profileName: rec {
    name = "h8r";
    version = "2.2.0";
    registry = "unknown";
