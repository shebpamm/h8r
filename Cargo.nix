...
let
  nixifiedLockHash = "430b8b2b01e225e5af1c441c6d39d4fb90bb75d83ac545120f5e4e52310dfed8";
...
in
{
  ...
  workspace = {
    h8r = rustPackages.unknown.h8r."2.4.0";
  };
  ...
  "unknown".h8r."2.4.0" = overridableMkRustCrate (profileName: rec {
    name = "h8r";
    version = "2.4.0";
    registry = "unknown";
